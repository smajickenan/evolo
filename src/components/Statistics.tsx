        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {statistics.map((stat, index) => (
            <motion.div
              ...
              className="bg-[#08183e]/20 backdrop-blur-sm rounded-2xl p-6 sm:p-8 hover:bg-white/15 transition-all duration-300"
            >
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-[#08183e] text-base sm:text-lg mb-4 leading-relaxed">
                  {stat.description}
                </p>
