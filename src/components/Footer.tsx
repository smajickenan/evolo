...
export const Footer = () => {
  return <footer className="bg-[#023157] border-t border-gray-200">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                <MailIcon size={16} className="mr-2 text-white" />
                <a href="mailto:eli.jerome2@gmail.com" className="text-white/60 hover:text-[#6fa8d6]">
                  eli.jerome2@gmail.com
                </a>
              </li>
              <li className="flex items-center">
                <PhoneIcon size={16} className="mr-2 text-white" />
                <a href="tel:5615040590" className="text-white/60 hover:text-[#6fa8d6]">
                  561-504-0590
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-[#6fa8d6]">
