  ...
  return (
    <section className="relative min-h-[90vh] flex items-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        >
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold bg-clip-text bg-gradient-to-r from-[#023157] to-[#023157]/80">
            Transform Your Business with a Website That Stands Out.
          </h1>
          <p className="text-lg sm:text-xl lg:text-2xl text-[#023157]/80">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="px-6 sm:px-8 py-2.5 sm:py-3 bg-[#023157] hover:bg-[#023157] text-white rounded-full text-base sm:text-lg font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-[#023157]/20 hover:-translate-y-0.5">
              Learn More
            </button>
          </div>
        </motion.div>
